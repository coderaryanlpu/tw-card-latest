        ...
        <div className="flex items-center h-16 md:h-20">
          ...
          <div className="flex flex-1 items-center justify-start">
            <a href="/" className="flex items-center gap-2 shrink-0 cursor-pointer hover:opacity-90 transition-opacity">
              ...
              <span className="text-xl md:text-2xl uppercase tracking-tight text-slate-900" style={{ fontFamily: 'system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif', fontWeight: 800 }}>
                TRUSTCARD
              </span>
            </a>
          </div>
